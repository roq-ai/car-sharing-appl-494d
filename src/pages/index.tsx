  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Experience seamless car sharing with Car Sharing Application - Your partner for efficient, eco-friendly, and affordable mobility solutions."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience seamless car sharing with Car Sharing Application - Your partner for efficient, eco-friendly, and affordable mobility solutions.`}
            </Text>
            <Box
